<%@page import="cosmetic.model.Customer"%>
	                ...
	                <tr>
	                	...
	                	<td class="text-right">
	                      <div class="btn-group">
	                        ...
	                        <a onclick="return confirm('Record will be deleted, are you sure?')" class="btn btn-danger" href="../deleteCustomer?id=<%=customer.getCustomer_id()%>"><i class="fa fa-trash"></i></a>
	                      </div>
	                    </td>
	                </tr>
	          <% count++;
